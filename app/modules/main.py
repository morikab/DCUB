...
def run_input_processing(user_input: models.UserInput) -> models.ModuleInput:
    ...
    return user_IO.UserInputModule.run_module(user_input=user_input, run_summary=run_summary, initiation_optimized_codons_num=initiation_optimized_codons_num)
