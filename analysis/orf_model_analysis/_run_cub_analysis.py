...
_cub_combined_figure(cai_distance_df, cub_optimal_labels, cai_organism_names,
                     ...
                     save_path=os.path.join(FIGURES_DIR, "combined_pca_cub_clustering_optimal.svg"))
_cub_combined_figure(cai_distance_df, cub_labels_k4, cai_organism_names,
                     k=4, title_suffix="k=4",
                     save_path=os.path.join(FIGURES_DIR, "combined_pca_cub_clustering_k4.svg"))
...
plt.tight_layout()
fig_cmp.savefig(os.path.join(FIGURES_DIR, "cub_vs_k2p_crosstab.svg"), bbox_inches="tight", facecolor=bg)
plt.close(fig_cmp)
...
_cub_strip_plot(cub_cva_opt_enhanced, cub_org_clusters_optimal, one_vs_all,
                ...
                save_path=os.path.join(FIGURES_DIR, f"graph_cub_k{cub_optimal_k}_cluster_vs_single.pdf"))

_cub_strip_plot(cub_cva_k4_enhanced, cub_org_clusters_k4, one_vs_all,
                "CUB k=4",
                save_path=os.path.join(FIGURES_DIR, "graph_cub_k4_cluster_vs_single.pdf"))
...
_sum_k4  = _cub_summary_plot(cub_cva_k4_enhanced, cub_org_clusters_k4, one_vs_all,
                             "k=4 (forced)", ax=ax_k4)
plt.tight_layout()
fig_panel.savefig(os.path.join(FIGURES_DIR, "graph_cub_cluster_summary_panel.pdf"),
...
plt.tight_layout()
fig3.savefig(os.path.join(FIGURES_DIR, "graph_k2p_vs_cub_cluster_comparison.pdf"),
             dpi=300, bbox_inches="tight")
plt.close(fig3)
